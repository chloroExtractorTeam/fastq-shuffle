...
my ( $ret, $stdout, $stderr ) = run_script("fastq-shuffle.pl", [ "-1", $filenames[0], "-2", $filenames[1], "-t", 6 ]);
...
( $ret, $stdout, $stderr ) = run_script("fastq-shuffle.pl", [ "-1", $filenames[0], "-2", $filenames[1], "-t", 6 ]);

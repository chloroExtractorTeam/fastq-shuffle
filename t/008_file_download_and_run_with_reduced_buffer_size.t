...
my ( $ret, $stdout, $stderr ) = run_script("fastq-shuffle.pl", [ "-1", $filenames[0], "-2", $filenames[1], "-s", "50M" ]);
...
( $ret, $stdout, $stderr ) = run_script("fastq-shuffle.pl", [ "-1", $filenames[0], "-2", $filenames[1], "-s", "50M" ]);
